...
class __TwigTemplate_c69a8d6c0bdd4ad94f4ebe8eced2a89b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  145 => 32,  136 => 27,  130 => 25,  128 => 24,  125 => 23,  123 => 21,  118 => 19,  114 => 18,  109 => 16,  100 => 9,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    {% for flash_error in app.flashes('verify_email_error') %}
        <div class=\"alert alert-danger\" role=\"alert\">Vous êtes déjà inscrit!</div>
    {% endfor %}
...
<h1>Inscription</h1>
    ...
    {{ form_start(registrationForm) }}
        ...
        {% if alert is defined %}
        <div class=\"alert text-danger bg-transparent\">{{ alert }}</div>
        {% endif %}
...
{% endblock %}
", "registration/register.html.twig", "/home/sara/Bureau/monProjet3/templates/registration/register.html.twig");
    }
}
