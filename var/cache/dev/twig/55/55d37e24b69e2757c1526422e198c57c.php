...
class __TwigTemplate_c33d78513f7eb13cf6d97bce5357acf0 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  121 => 27,  115 => 23,  109 => 18,  101 => 15,  98 => 14,  96 => 13,  93 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
         Vous êtes connécté à {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Déconnection</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "/home/sara/Bureau/monProjet3/templates/security/login.html.twig");
    }
}
